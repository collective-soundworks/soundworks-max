...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 196.0, 231.0, 32.0, 22.0 ],
					"text" : "print"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.5, 155.0, 54.0, 22.0 ],
					"text" : "deferlow"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.5, 186.0, 50.0, 22.0 ],
					"text" : "dispose"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 381.5, 105.5, 32.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.5, 238.0, 47.0, 22.0 ],
					"text" : "dict.iter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 381.5, 68.0, 127.0, 22.0 ],
					"text" : "dict.unpack closeMax:"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 381.5, 31.0, 184.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "dictionary", "dictionary" ],
					"patching_rect" : [ 118.5, 191.0, 184.0, 22.0 ],
					"text" : "soundworks.shared-state globals"
				}
