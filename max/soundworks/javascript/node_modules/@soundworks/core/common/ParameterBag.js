...
const types = {
  boolean: {
    ...
    get defaultOptions() {
      return Object.assign((0, _lodash.default)(sharedOptions), {});
    },
...
class ParameterBag {
  static validateSchema(schema) {
    for (let name in schema) {
      ...
      required.forEach(function (key) {
        if (def.event === true && key === 'default') {// do nothing, default is always null for `event` params
  ...
  constructor(schema, initValues = {}) {
    ...
    schema = (0, _lodash.default)(schema);
    initValues = (0, _lodash.default)(initValues);
    /**
     * List of parameters.
     *
    ...
    this._schema = {};
    ParameterBag.validateSchema(schema); // make shure initValues make sens according to the given schema
    ...
    for (let [name, def] of Object.entries(schema)) {
      ...
      this._schema[name] = def; // coerce init value and store in definition
