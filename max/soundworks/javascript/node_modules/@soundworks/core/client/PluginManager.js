...
`);
    ...
    if (!this._instances[name]) {
      ...
      const instance = new ctor(this._client, name, options); // wait, at least,  for the plugin manager start signal

      instance.signals.start.add(this.signals.start); // handle dependency tree
      ...
      instance.signals.errored.addObserver(onPluginErrored); // store instance
