...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 148.0, 237.0, 83.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 507.0, 288.0, 83.0, 20.0 ],
...
,
					"patching_rect" : [ 379.5, 318.0, 74.0, 42.0 ],
...
,
					"patching_rect" : [ 379.5, 259.0, 87.0, 20.0 ],
					"text" : "p handle_error"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 329.0, 89.0, 20.0 ],
					"text" : "s #0_debug"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 379.5, 289.0, 54.0, 20.0 ],
					"text" : "route npm"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 472.0, 167.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 71.0, 51.0, 41.0, 22.0 ],
					"text" : "View",
...
, 			{
				"box" : 				{
					...
					"save" : [ "#N", "thispatcher", ";", "#Q", "window", "flags", "nogrow", "close", "nozoom", "nofloat", "menu", "minimize", ";", "#Q", "window", "constrain", 50, 50, 32768, 32768, ";", "#Q", "window", "size", 434, 203, 1037, 523, ";", "#Q", "window", "title", ";", "#Q", "window", "exec", ";", "#Q", "savewindow", 1, ";", "#Q", "end", ";" ],
					"text" : "thispatcher"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 114.5, 293.5, 250.0, 20.0 ],
					"saved_object_attributes" : 					{
						"autostart" : 1,
						"defer" : 0,
						"node_bin_path" : "",
...
,
					"text" : "node.script soundworks.shared-state.mjs @autostart 1",
					"textfile" : 					{
						"filename" : "soundworks.shared-state.mjs",
						"flags" : 0,
						"embed" : 0,
						"autowatch" : 1
					}
